...
%let prefix_dir=c:\karol\analiza6_poziom_klienta\project\students\11111\modelowanie_rj\1_model_ngb\;
...
proc freq data=inlib.abt_app noprint;
table &tar / missing out=wyj.&tar;
run;
...
proc freq data=abt.train noprint;
table &tar / missing out=wyj.train_&tar;
run;
