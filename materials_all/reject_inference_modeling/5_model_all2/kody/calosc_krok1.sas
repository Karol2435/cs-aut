...
%let prefix_dir=c:\karol\analiza6_poziom_klienta\project\students\11111\modelowanie_rj\5_model_all2\;
...
/*data wyj.Zmienne_definicja;*/
/*set wyj.Zmienne_definicja_all;*/
/*where upcase(zmienna) in*/
/*(*/
/*'ACT_CINS_N_STATB'*/
/*'APP_CHAR_JOB_CODE'*/
/*'APP_CHAR_GENDER'*/
...
data wyj.chosen_variables;
set wyj.chosen_variables_all;
where zmienna in ('ACT_CC' 'ACT_CINS_CC' 'ACT_CINS_MIN_SENIORITY' 
'ACT_CINS_N_STATC' 'APP_CHAR_JOB_CODE' 'APP_CHAR_MARITAL_STATUS' 
'APP_LOAN_AMOUNT' 'APP_NUMBER_OF_CHILDREN');
run;


data wyj.Dobre_zmienne;
set wyj.Dobre_zmienne_all;
where _VARIABLE_ in ('ACT_CC' 'ACT_CINS_CC' 'ACT_CINS_MIN_SENIORITY' 
'ACT_CINS_N_STATC' 'APP_CHAR_JOB_CODE' 'APP_CHAR_MARITAL_STATUS' 
'APP_LOAN_AMOUNT' 'APP_NUMBER_OF_CHILDREN');
run;

data abt.Train_woe;
set abt.Train_woe_all;
waga=0.01;
keep default: outstanding credit_limit cid aid period waga
WOE_ACT_CC 
WOE_ACT_CINS_CC 
WOE_ACT_CINS_MIN_SENIORITY 
WOE_ACT_CINS_N_STATC 
WOE_APP_CHAR_JOB_CODE 
WOE_APP_CHAR_MARITAL_STATUS 
WOE_APP_LOAN_AMOUNT 
WOE_APP_NUMBER_OF_CHILDREN
ACT_CC 
ACT_CINS_CC 
...
proc logistic data=train_woe desc outest=wyj.betas_w
outmodel=wyj.model_w;
weight waga;
model &tar=
WOE_ACT_CC 
WOE_ACT_CINS_CC 
