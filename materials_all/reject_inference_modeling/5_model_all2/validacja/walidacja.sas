/*walidacja all*/
%let tytul=PD default12new model on INS based on LOW strategy 2 trial;
%let kat_kody=c:\karol\analiza6_poziom_klienta\project\students\11111\modelowanie_rj\5_model_all2\validacja\;
