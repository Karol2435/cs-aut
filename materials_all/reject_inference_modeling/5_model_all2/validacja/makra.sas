...
plot &period*
(score_P5 score_P25 score_P50 score_Mean score_P75 score_P95) 
...
proc gchart data=score_v;
block &&v&i / discrete group=&period sumvar=percent type=sum 
patternid=group subgroup=number;
label number='Number of applications' &&v&i="Partial score";
format percent nlpct12.2;
run;
quit;
...
plot &period*avg_score=name / overlay legend;
...
patternid=group subgroup=number axis=0 to &cent by 0.02;
label number='Number of applications' band='Score band'
bad_rate="&measure";
