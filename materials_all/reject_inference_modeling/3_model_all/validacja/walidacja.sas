/*walidacja all*/
%let tytul=PD default12new model on INS based on LOW strategy;
%let kat_kody=c:\karol\analiza6_poziom_klienta\project\students\11111\modelowanie_rj\3_model_all\validacja\;
