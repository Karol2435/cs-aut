...
%let prefix_dir=c:\karol\analiza6_poziom_klienta\project\students\11111\modele\risk_ins_segmentacja\not_missing\;
...
and not missing(Act_cins_seniority);
%mend;
...
WOE_ACT_CINS_UTL 
WOE_AGS12_MEAN_CMAXI_DUE 
/*WOE_AGS12_MIN_CMAXI_DUE */
