...
%let prefix_dir=c:\karol\analiza6_poziom_klienta\project\students\11111\modele\risk_ins_segmentacja\missing\;
...
and missing(Act_cins_seniority);
%mend;
