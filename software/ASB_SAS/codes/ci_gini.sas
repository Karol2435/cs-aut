...
proc logistic data=kal.score&the_best_model desc namelen=32;
...
%put &c;
data d;
set kal.score&the_best_model end=e;
n=_n_;
...
proc sql noprint;
select count(distinct &score_points) into :n_score from freq;
quit;
%put &n_score;
...
data kal.ci_c_ar&the_best_model;
set czesci;
label
