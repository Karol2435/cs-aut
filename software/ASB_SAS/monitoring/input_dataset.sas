...
libname inlib "c:\karol\oferta_zajec\sas_cs\asb_szybkie\inlib\" compress=yes;
libname out "c:\karol\oferta_zajec\sas_cs_en\asb_en\monitoring\data\" compress=yes;
